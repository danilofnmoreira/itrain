...
class ContactTest {
    ...
    @Nested
    @DisplayName(value = "after adding a gym to contact, they must be in a mutual relationship")
    class after_adding_a_gym_to_contact_they_must_be_in_a_mutual_relationship {
        ...
        void test() {
            ...
            assertThat(contact.getGym(), is(sameInstance(gym)));
            assertThat(gym.getContacts(), hasItem(contact));
        }
    ...
    void when_fill_a_contact_from_other_they_must_have_the_same_properties_values() {
        ...
        assertThat(actual, samePropertyValuesAs(contact, "gym"));
    }
}