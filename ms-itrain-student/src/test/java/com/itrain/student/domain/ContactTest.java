...
class ContactTest {
    ...
    @Nested
    @DisplayName(value = "after adding a student to contact, they must be in a mutual relationship")
    class after_adding_a_student_to_contact_they_must_be_in_a_mutual_relationship {
        ...
        void test() {
            ...
            assertThat(contact.getStudent(), is(sameInstance(student)));
            assertThat(student.getContacts(), hasItem(contact));
        }
    ...
    void when_fill_a_contact_from_other_they_must_have_the_same_properties_values() {
        ...
        assertThat(actual, samePropertyValuesAs(contact, "student"));
    }
}